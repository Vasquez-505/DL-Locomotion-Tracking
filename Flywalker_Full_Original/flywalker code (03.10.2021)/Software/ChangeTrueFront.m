function handles = ChangeTrueFront(handles)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%             handles.v.CurrentBodyStdX(FrameNumber) = handles.v.CurrentBodyStdY(FrameNumber)/3;
            ...
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            % Alexandre -> -5 seems to work the best
            
            back = [handles.v.CurrentBodyX(FrameNumber)-handles.v.CurrentBodyStdY(FrameNumber)-5,handles.v.CurrentBodyY(FrameNumber)-handles.v.CurrentBodyStdY(FrameNumber)];
            
            handles.v.CurrentBodyX(FrameNumber) = (back(1)+handles.v.CurrentFrontX(FrameNumber))/2;
%             handles.v.CurrentBodyY(FrameNumber) = (back(2)+handles.v.CurrentFrontY(FrameNumber))/2;
            
            handles.v.CurrentBodyStdY(FrameNumber) = sqrt((back(1)-handles.v.CurrentFrontX(FrameNumber))^2-(back(2)-handles.v.CurrentFrontY(FrameNumber))^2)/2;
%             handles.v.CurrentBodyStdX(FrameNumber) = handles.v.CurrentBodyStdY(FrameNumber)/3;
...
%                 abs(handles.v.CurrentBodyY(FrameNumber) - handles.v.CurrentFrontY(FrameNumber));
            ...
            back = [handles.v.CurrentBodyX(FrameNumber)-handles.v.CurrentBodyStdX(FrameNumber),handles.v.CurrentBodyY(FrameNumber)-handles.v.CurrentBodyStdX(FrameNumber)];
            
            handles.v.CurrentBodyX(FrameNumber) = (back(1)+handles.v.CurrentFrontX(FrameNumber))/2;
%             handles.v.CurrentBodyY(FrameNumber) = (back(2)+handles.v.CurrentFrontY(FrameNumber))/2;
            
            handles.v.CurrentBodyStdX(FrameNumber) = sqrt((back(1)-handles.v.CurrentFrontX(FrameNumber))^2-(back(2)-handles.v.CurrentFrontY(FrameNumber))^2)/2;
